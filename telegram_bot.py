...
print("Login")
BOT_INSTAGRAM_ACCOUNT = L.login("botko.botkic","StevoLjilja2710")   #login details
print("Login successful")

PROFILES = ["tackleberry_84", "nervozni_pingvin", "otac_branislav", "gangsteritogroup", "ptica.drkacica", "ludkoleptir", "kojavitez1981", "trkacko_pile", "gospodar_prsljenova", "golman_u_penziji", "riba.cekicara"] #add users to give posts
